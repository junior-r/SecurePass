...
from .views import home, registro, editProfile, createPassword, view_passwords, contactos, update_password, delete_password
...
urlpatterns = [
    ...
    path('<username>/', editProfile, name='editProfile'),
]
